declare const BRIDGE_MODULE = "aptos_nft_bridge";
declare const MINT_MODULE = "mint";
declare const BRIDGE_FUNCTIONS: {
    Initialize: string;
    MoveBridgeResource: string;
    AddValidator: string;
    Lock721: string;
    Lock1155: string;
    Claim721: string;
    Claim1155: string;
    OwnsNFT: string;
    ClaimValidatorRewards: string;
};
declare const MINT_FUNCTIONS: {
    MINT_TO: string;
    MINT_1155_TO: string;
};
declare enum CONTRACT_ERROR_CODES {
...
declare const CHAIN_ID = "APTOS";
declare const CLAIM_FEE_5_APT: number;
declare const CLAIM_FEE_POINT_1_APT: number;
export { BRIDGE_MODULE, BRIDGE_FUNCTIONS, CONTRACT_ERROR_CODES, CHAIN_ID, MINT_MODULE, MINT_FUNCTIONS, CLAIM_FEE_5_APT, CLAIM_FEE_POINT_1_APT, };
