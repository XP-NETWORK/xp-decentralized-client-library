...
export type TAptosHandler = TNftChain<Account, TClaimData, never, PendingTransactionResponse, Aptos> & MintNft<Account, TAptosMintArgs, never, string> & DeployCollection<Account, {
    name: string;
    symbol: string;
}, never, string>;
