...
export type MintSft<Signer, MintArgs, GasArgs, RetTx> = {
    mintSft: (signer: Signer, ma: MintArgs, amount: bigint, gasArgs?: GasArgs) => Promise<RetTx>;
};
export type Mint<Signer, MintArgs, GasArgs, RetTx> = MintNft<Signer, MintArgs, GasArgs, RetTx> & MintSft<Signer, MintArgs, GasArgs, RetTx>;
export type DeployNFTCollection<Signer, DeployArgs, GasArgs, RetTx> = {
    deployNftCollection: (signer: Signer, da: DeployArgs, ga?: GasArgs) => Promise<RetTx>;
};
...
export type TLockNFT<Signer, ExtraArgs, RetTx> = {
     ...
     */
    lockNft: (signer: Signer, sourceNft: string, destinationChain: TSupportedChain, to: string, tokenId: string, metaDataUri: string, extraArgs?: ExtraArgs) => Promise<{
        ret: RetTx;
        hash: () => string;
    }>;
};
...
export type TLockSFT<Signer, ExtraArgs, RetTx> = {
     ...
     * @returns A promise that resolves to the transaction which is of type {RetTx}.
     */
    lockSft: (signer: Signer, sourceNft: string, destinationChain: TSupportedSftChain, to: string, tokenId: string, amt: bigint, metaDataUri: string, extraArgs?: ExtraArgs) => Promise<{
        ret: RetTx;
        hash: () => string;
    }>;
};
 ...
 * @template RetTx The type of the return value after a transaction.
 */
export type TMultipleNftChain<Signer, ClaimData, ExtraArgs, RetTx, Provider> = TLockSFT<Signer, ExtraArgs, RetTx> & TClaimSFT<Signer, ClaimData, ExtraArgs, RetTx> & TGetNFTData<ExtraArgs> & TGetBalance<Signer, ExtraArgs> & TGetProvider<Provider>;
/**
 ...
 * @template RetTx The type of the return value after a transaction.
 */
export type TNftChain<Signer, ClaimData, ExtraArgs, RetTx, Provider> = TSingularNftChain<Signer, ClaimData, ExtraArgs, RetTx, Provider> & TMultipleNftChain<Signer, ClaimData, ExtraArgs, RetTx, Provider>;
/**
