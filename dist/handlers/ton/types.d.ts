...
export type TTonHandler = TSingularNftChain<Sender, ClaimData, unknown, undefined, TonClient> & MintNft<Sender, TonMintArgs, undefined> & DeployCollection<Sender, TonMintArgs, never, string>;
