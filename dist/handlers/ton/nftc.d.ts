...
export declare class TestnetNftCollection implements Contract {
    static init(owner_address: Address, collection_content: Cell, royalty_params: RoyaltyParams): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(owner_address: Address, collection_content: Cell, royalty_params: RoyaltyParams): Promise<TestnetNftCollection>;
    static fromAddress(address: Address): TestnetNftCollection;
