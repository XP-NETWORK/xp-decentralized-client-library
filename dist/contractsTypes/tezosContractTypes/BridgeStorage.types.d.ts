...
export type Storage = {
    ...
    staking_signatures: BigMap<string, Array<{
        signer: string;
        signature: bytes;
    }>>;
...
type Methods = {
    approve_stake: (staker: address, validator_address_with_signer_and_sig: Array<{
    ...
    change_validator_status: (validator: address, status: boolean) => Promise<void>;
    change_chain_royalty_receiver: (chain: string, royalty_receiver: string) => Promise<void>;
...
export type BridgeStorageContractType = ContractAbstractionFromContractType<contractTypes>;
export type BridgeStorageWalletType = WalletContractAbstractionFromContractType<contractTypes>;
export {};
//# sourceMappingURL=BridgeStorage.types.d.ts.map