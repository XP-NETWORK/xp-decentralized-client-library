...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../evm/common";
...
export interface IHRC extends BaseContract {
    ...
    getFunction(nameOrSignature: "associate"): TypedContractMethod<[], [bigint], "nonpayable">;
    getFunction(nameOrSignature: "dissociate"): TypedContractMethod<[], [bigint], "nonpayable">;
    filters: {};
}
//# sourceMappingURL=IHRC.d.ts.map