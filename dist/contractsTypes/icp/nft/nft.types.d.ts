...
export type RevokeTokenApprovalResult = {
    'Ok': bigint;
} | {
...
export type SupportedStandards = Array<{
    'url': string;
    'name': string;
}>;
export type SupportedStandards__1 = Array<{
    'url': string;
    'name': string;
}>;
...
//# sourceMappingURL=nft.types.d.ts.map