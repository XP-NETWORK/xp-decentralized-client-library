...
export namespace ChainFactoryConfigs {
  export async function TestNet() {
    ...
    const oldStorage = BridgeStorage__factory.connect(
      "0x8184bCDC0a4C24D1cB8e054E389660B5b7160186",
      skale,
    );
      ...
      bridgeChains: {
        bscParams: {
          ...
          bridge: ethers.getAddress(
            "0xA86704500C991a5C1976756Ee3f458d59240A6cE",
          ),
        ...
        hederaParams: {
          ...
          bridge: ethers.getAddress(
            "0x0C687Dc235f8e461441d69Dc6aD123EAe7401744",
          ),
        ...
        moonbeamParams: {
          bridge: ethers.getAddress(
            "0x4144b9255B45691E1Cc9BEdE04726b26ebd6C90A",
          ),
          identifier: "MOONBEAM",
        ...
        vechainParams: {
          ...
          bridge: ethers.getAddress(
            "0x7111eb5f8d9dA472e9608f2ab3De275C040D60B2",
          ),
          royaltySalePrice: 10000,
          storage,
        },
  ...
  export async function MainNet() {
    ...
    const storage = BridgeStorage__factory.connect(
      "0x6fF8599f69B50Fbb906bD8b86Db512F431C34461",
      optimism,
    );
    const oldStorage = BridgeStorage__factory.connect(
    ...
    return {
      bridgeChains: {
        ...
        avaxParams: {
          ...
          bridge: ethers.getAddress(
            "0x92764FF21a1a8cC4e8eEec43ED04Bea3B76D8fD3",
          ),
          royaltySalePrice: 10000,
          storage,
        },
        ...
        ethParams: {
          bridge: ethers.getAddress(
            "0x4B2A837613bA45C734439155CC7030c79095a2ed",
          ),
          identifier: "ETHEREUM",
          provider: new JsonRpcProvider(
